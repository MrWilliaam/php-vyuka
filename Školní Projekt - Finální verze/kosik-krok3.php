	...
	<main>
	 <section class="section">
		<div class="container stack">
		 <h1>
			Košík – krok 3: Shrnutí objednávky
		 </h1>
			 ...
			 <div class="card-pad stack">
				<div class="notice">
				 ...
				 <div class="small" style="margin-top:6px;">
					Statický výpis položek a souhlas s podmínkami.
				 </div>
				</div>
				<table aria-label="Shrnutí objednávky" class="table">
				 <thead>
					<tr>
					 <th>
						Položka
				 ...
				 <tbody data-cart-items="" data-cart-layout="nqp">
				 </tbody>
				</table>
				<div class="between">
				 <strong>
				...
				<div class="between wrap">
				 <a class="btn" href="kosik-krok2.html">
					Zpět
				 </a>
				 <a class="btn btn-primary" href="kosik-potvrzeni.html">
					Odeslat objednávku
				 </a>
				</div>
			 </div>
